...
class Peminjaman_mobile extends StatefulWidget {
  const Peminjaman_mobile({super.key});

  @override
  State<Peminjaman_mobile> createState() => _Peminjaman_MobileState();
}
...
class _Peminjaman_MobileState extends State<Peminjaman_mobile> {
  getBarang() async {
    refreshData();
    setState(() {});
    await FirebaseFirestore.instance
          ...
          child: loading
              ...
              : Container(
                  decoration: BoxDecoration(
                      ...
                      color: Color.fromARGB(162, 41, 39, 39),
                      border: Border.all(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              BarangYangDipinjam[x],
                                                                              style: GoogleFonts.beVietnamPro(fontSize: 12, color: Colors.black),
                                                                            ),
                                                                          ],
                                                                        ),
                                                                      ),
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: Row(
                                                                                  ...
                                                                                  children: [
                                                                                    for (int i = j; i < j + 3 && i < KumpulanNama.length; i++)
                                                                                      Container(
                                                                                        child: Row(
                                                                                          children: [
                                                                                            Container(
                                                                                                                        ...
                                                                                                                        child: Column(
                                                                                                                          children: [
                                                                                                                            ...
                                                                                                                            Container(
                                                                                                                              ...
                                                                                                                              height: 40,
                                                                                                                              child: Center(
                                                                                                                                child: Text(" Jumlah Barang Saat Ini = " + (KumpilanTotalJumlahBarang[i] - KumpulanBarangTerpakai[i]).toString(), style: GoogleFonts.beVietnamPro(fontSize: 12, color: Colors.white, fontWeight: FontWeight.normal)),
                                                                                                                              ),
                                                                                                                            ),
                                                                                                                            SizedBox(
                                                                                                                              height: 20,
                                                                                                                                          ...
                                                                                                                                          children: [
                                                                                                                                            ...
                                                                                                                                            GestureDetector(
                                                                                                                                              ...
                                                                                                                                              child: Container(
                                                                                                                                                ...
                                                                                                                                                height: 30,
                                                                                                                                                child: Center(
                                                                                                                                                  child: Text("PINJAM", style: GoogleFonts.beVietnamPro(fontSize: 12, fontWeight: FontWeight.bold, color: const Color.fromARGB(255, 7, 7, 10))),
                                                                                                                                                ),
                                                                                                                                              ),
                                                                                                                                            ),
                                                                                                                                          ],
                                                                                                      ...
                                                                                                      child:
                                                                                                        ...
                                                                                                        child: Column(
                                                                                                          ...
                                                                                                          children: [
                                                                                                            ...
                                                                                                            Text(
                                                                                                              KumpulanNama[i],
                                                                                                              style: GoogleFonts.beVietnamPro(fontSize: 12, color: Colors.white, fontWeight: FontWeight.normal),
                                                                                                              textAlign: TextAlign.center,
                                                                                                            ),
                                                                                                          ],
                                                                                                        ),
                                                                                                                ...
                                                                                                                children: [
                                                                                                                  Center(
                                                                                                                    child: Container(
                                                                                                                      ...
                                                                                                                      width: 367,
                                                                                                                      child: Padding(
                                                                                                                        padding: EdgeInsets.symmetric(horizontal: 43, vertical: 73),
                                                                                                                        child: Column(
                                                                                                                          children: [
                                                                                                                            Container(
                                                                                                                              decoration: BoxDecoration(
                                                                                                                            ...
                                                                                                                            KumpulanSekaliPakai[i]
                                                                                                                                ...
                                                                                                                                ? Container(
                                                                                                                                    ...
                                                                                                                                    height: 40,
                                                                                                                                    child: Center(
                                                                                                                                      child: KumpulanSatuanMeter[i]
                                                                                                                                          ? Text(
                                                                                                                                              " Panjang Barang Tersisa = " + (KumpilanTotalJumlahBarang[i].toString() + " M"),
                                                                                                                                              style: GoogleFonts.beVietnamPro(fontSize: 12, color: Colors.white, fontWeight: FontWeight.normal),
                                                                                                                                              textAlign: TextAlign.center,
                                                                                                                                            )
                                                                                                                                          : Text(" Jumlah Barang Saat ini = " + (KumpilanTotalJumlahBarang[i].toString()), style: GoogleFonts.beVietnamPro(fontSize: 12, color: Colors.white, fontWeight: FontWeight.normal), textAlign: TextAlign.center),
                                                                                                                                    ),
                                                                                                                                  )
                                                                                                                            ...
                                                                                                                            Row(
                                                                                                                              children: [
                                                                                                                                Text("Jumlah Yang Dipinjam", style: GoogleFonts.beVietnamPro(fontSize: 12, color: Colors.white, fontWeight: FontWeight.normal)),
                                                                                                                              ],
                                                                                                                            ),
                                                                                                                            SizedBox(
                                                                                                                              height: 5,
